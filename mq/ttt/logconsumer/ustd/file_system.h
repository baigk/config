...
static size_t get_files(const char *path, vector<string> &files, const char *pattern = NULL)
{
    files.clear();
...
static size_t get_all_files(const char *path, vector<string> &files, const char *pattern = NULL)
{
    char buffer[4096] = {0x00};
    DIR *pdir = opendir(path);
...
static size_t get_dirs(const char *path, vector<string> &dirs)
{
	char buffer[4096] = {0x00};
	DIR *pdir = opendir(path);
...
static size_t get_all_dirs(const char *path, vector<string> &dirs)
{
    char buffer[4096] = {0x00};
    DIR *pdir = opendir(path);
